...
import utils
import json
from chatbot.tools import tool_img
from chatbot.tools import tool_voice
import gradio as gr
...
class Chatbot:
    def __init__(self):
        self.name = "RDC rag chatbot"
        self.desc = "RDC Retrieval Augument Generation for Confluence files"
